// Code generated by the Encore v1.39.2 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
    return `https://${name}-omni-backend-4hn2.encr.app`
}
...
/**
 * Client is an API client for the omni-backend-4hn2 Encore application. 
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "omni-backend-4hn2-Generated-TS-Client (Encore/v1.39.2)";
        }
